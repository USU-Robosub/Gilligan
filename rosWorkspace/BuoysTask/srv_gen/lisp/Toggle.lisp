...
(cl:defmethod cl:initialize-instance :after ((m <Toggle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Toggle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name BuoysTask-srv:<Toggle-request> is deprecated: use BuoysTask-srv:Toggle-request instead.")))

(cl:ensure-generic-function 'enabled-val :lambda-list '(m))
(cl:defmethod enabled-val ((m <Toggle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader BuoysTask-srv:enabled-val is deprecated.  Use BuoysTask-srv:enabled instead.")
  (enabled m))
...
(cl:defmethod cl:initialize-instance :after ((m <Toggle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Toggle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name BuoysTask-srv:<Toggle-response> is deprecated: use BuoysTask-srv:Toggle-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Toggle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader BuoysTask-srv:result-val is deprecated.  Use BuoysTask-srv:result instead.")
  (result m))
