...
(cl:defmethod cl:initialize-instance :after ((m <Toggle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Toggle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ObstacleCourseTask-srv:<Toggle-request> is deprecated: use ObstacleCourseTask-srv:Toggle-request instead.")))

(cl:ensure-generic-function 'enabled-val :lambda-list '(m))
(cl:defmethod enabled-val ((m <Toggle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ObstacleCourseTask-srv:enabled-val is deprecated.  Use ObstacleCourseTask-srv:enabled instead.")
  (enabled m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Toggle-request>)))
  ...
  "ObstacleCourseTask/ToggleRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Toggle-request)))
  "Returns string type for a service object of type 'Toggle-request"
  "ObstacleCourseTask/ToggleRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Toggle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Toggle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ObstacleCourseTask-srv:<Toggle-response> is deprecated: use ObstacleCourseTask-srv:Toggle-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Toggle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ObstacleCourseTask-srv:result-val is deprecated.  Use ObstacleCourseTask-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Toggle-response>)))
  ...
  "ObstacleCourseTask/ToggleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Toggle-response)))
  "Returns string type for a service object of type 'Toggle-response"
  "ObstacleCourseTask/ToggleResponse")
